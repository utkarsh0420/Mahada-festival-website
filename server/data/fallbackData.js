...
export const OFFICIAL_COMMITTEE_MEMBERS = [
...
export const FALLBACK_FESTIVAL_EVENTS = [
  {
    _id: "evt-fest-1",
    category: "arrival",
    categoryEn: "Arrival",
...
export const FALLBACK_YEARLY_EVENTS = [
  {
    _id: "evt-year-1",
    category: "ऐतिहासिक",
    categoryEn: "Historic",
...
export const FALLBACK_CONTACTS = OFFICIAL_COMMITTEE_MEMBERS.map((m, idx) => ({
  _id: `contact-cm-${idx + 1}`,
  nameMr: m.nameMr,
  nameEn: m.nameEn,
  roleMr: m.roleMr,
  roleEn: m.roleEn,
